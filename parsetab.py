...
_lr_productions = [
  ...
  ('program -> PROGRAM ID COLON vars main function','program',6,'p_program','lexAndSyn.py',108),
  ('program -> PROGRAM ID COLON main function','program',5,'p_program','lexAndSyn.py',109),
  ('program -> PROGRAM ID COLON vars main','program',5,'p_program','lexAndSyn.py',110),
  ('program -> PROGRAM ID COLON main','program',4,'p_program','lexAndSyn.py',111),
  ('main -> MAIN LPAREN RPAREN LBRACE bloqueAux RBRACE','main',6,'p_main','lexAndSyn.py',115),
  ('main -> MAIN LPAREN RPAREN LBRACE vars bloqueAux RBRACE','main',7,'p_main','lexAndSyn.py',116),
  ('vars -> VAR varAux1','vars',2,'p_vars','lexAndSyn.py',124),
  ('varAux1 -> tipo varAux2 SEMICOLON','varAux1',3,'p_varAux1','lexAndSyn.py',128),
  ('varAux1 -> tipo varAux2 SEMICOLON varAux1','varAux1',4,'p_varAux1','lexAndSyn.py',129),
  ('varAux2 -> ID','varAux2',1,'p_varAux2','lexAndSyn.py',133),
  ('varAux2 -> ID COMA varAux2','varAux2',3,'p_varAux2','lexAndSyn.py',134),
  ('tipo -> INT','tipo',1,'p_tipo','lexAndSyn.py',157),
  ('tipo -> FLOAT','tipo',1,'p_tipo','lexAndSyn.py',158),
  ('tipo -> CHAR','tipo',1,'p_tipo','lexAndSyn.py',159),
  ('tipoFunc -> INT','tipoFunc',1,'p_tipoFunc','lexAndSyn.py',164),
  ('tipoFunc -> FLOAT','tipoFunc',1,'p_tipoFunc','lexAndSyn.py',165),
  ('tipoFunc -> CHAR','tipoFunc',1,'p_tipoFunc','lexAndSyn.py',166),
  ('tipoFunc -> VOID','tipoFunc',1,'p_tipoFunc','lexAndSyn.py',167),
  ('bloque -> LBRACE RBRACE','bloque',2,'p_bloque','lexAndSyn.py',172),
  ('bloque -> LBRACE bloqueAux RBRACE','bloque',3,'p_bloque','lexAndSyn.py',173),
  ('function -> FUNCTION tipoFunc ID LPAREN RPAREN LBRACE RBRACE','function',7,'p_function','lexAndSyn.py',177),
  ('function -> FUNCTION tipoFunc ID LPAREN RPAREN LBRACE vars bloqueAux RBRACE','function',9,'p_function','lexAndSyn.py',178),
  ('function -> FUNCTION tipoFunc ID LPAREN vars RPAREN LBRACE bloqueAux RBRACE','function',9,'p_function','lexAndSyn.py',179),
  ('function -> FUNCTION tipoFunc ID LPAREN vars RPAREN LBRACE vars bloqueAux RBRACE','function',10,'p_function','lexAndSyn.py',180),
  ('function -> FUNCTION tipoFunc ID LPAREN RPAREN LBRACE RBRACE function','function',8,'p_function','lexAndSyn.py',181),
  ('function -> FUNCTION tipoFunc ID LPAREN RPAREN LBRACE vars bloqueAux RBRACE function','function',10,'p_function','lexAndSyn.py',182),
  ('function -> FUNCTION tipoFunc ID LPAREN vars RPAREN LBRACE bloqueAux RBRACE function','function',10,'p_function','lexAndSyn.py',183),
  ('function -> FUNCTION tipoFunc ID LPAREN vars RPAREN LBRACE vars bloqueAux RBRACE function','function',11,'p_function','lexAndSyn.py',184),
  ('bloqueAux -> estatuto','bloqueAux',1,'p_bloqueAux','lexAndSyn.py',192),
  ('bloqueAux -> estatuto bloqueAux','bloqueAux',2,'p_bloqueAux','lexAndSyn.py',193),
  ('while -> WHILE LPAREN expresion RPAREN bloque','while',5,'p_while','lexAndSyn.py',197),
  ('estatuto -> asignacion','estatuto',1,'p_estatuto','lexAndSyn.py',201),
  ('estatuto -> condicion','estatuto',1,'p_estatuto','lexAndSyn.py',202),
  ('estatuto -> escritura','estatuto',1,'p_estatuto','lexAndSyn.py',203),
  ('estatuto -> while','estatuto',1,'p_estatuto','lexAndSyn.py',204),
  ('estatuto -> comparacion','estatuto',1,'p_estatuto','lexAndSyn.py',205),
  ('asignacion -> ID EQUAL expresion SEMICOLON','asignacion',4,'p_asignacion','lexAndSyn.py',209),
  ('comparacion -> ID DOUBLEEQUAL expresion SEMICOLON','comparacion',4,'p_comparacion','lexAndSyn.py',214),
  ('condicion -> IF LPAREN expresion RPAREN bloque SEMICOLON','condicion',6,'p_condicion','lexAndSyn.py',218),
  ('condicion -> IF LPAREN expresion RPAREN bloque ELSE bloque SEMICOLON','condicion',8,'p_condicion','lexAndSyn.py',219),
  ('escritura -> PRINT LPAREN escrituraAux RPAREN SEMICOLON','escritura',5,'p_escritura','lexAndSyn.py',223),
  ('escrituraAux -> expresion','escrituraAux',1,'p_escrituraAux','lexAndSyn.py',227),
  ('escrituraAux -> CTE_STRING','escrituraAux',1,'p_escrituraAux','lexAndSyn.py',228),
  ('escrituraAux -> expresion COMA escrituraAux','escrituraAux',3,'p_escrituraAux','lexAndSyn.py',229),
  ('escrituraAux -> CTE_STRING COMA escrituraAux','escrituraAux',3,'p_escrituraAux','lexAndSyn.py',230),
  ('expresion -> exp','expresion',1,'p_expresion','lexAndSyn.py',234),
  ('expresion -> exp LOWERTHAN exp','expresion',3,'p_expresion','lexAndSyn.py',235),
  ('expresion -> exp MORETHAN exp','expresion',3,'p_expresion','lexAndSyn.py',236),
  ('expresion -> exp DIFFERENT exp','expresion',3,'p_expresion','lexAndSyn.py',237),
  ('exp -> termino','exp',1,'p_exp','lexAndSyn.py',241),
  ('exp -> termino PLUS exp','exp',3,'p_exp','lexAndSyn.py',242),
  ('exp -> termino MINUS exp','exp',3,'p_exp','lexAndSyn.py',243),
  ('termino -> factor','termino',1,'p_termino','lexAndSyn.py',247),
  ('termino -> factor TIMES termino','termino',3,'p_termino','lexAndSyn.py',248),
  ('termino -> factor DIVIDE termino','termino',3,'p_termino','lexAndSyn.py',249),
  ('factor -> LPAREN expresion RPAREN','factor',3,'p_factor','lexAndSyn.py',253),
  ('factor -> factorAux','factor',1,'p_factor','lexAndSyn.py',254),
  ('factorAux -> PLUS var_cte','factorAux',2,'p_factorAux','lexAndSyn.py',258),
  ('factorAux -> MINUS var_cte','factorAux',2,'p_factorAux','lexAndSyn.py',259),
  ('factorAux -> var_cte','factorAux',1,'p_factorAux','lexAndSyn.py',260),
  ('var_cte -> ID','var_cte',1,'p_var_cte','lexAndSyn.py',264),
  ('var_cte -> CTE_I','var_cte',1,'p_var_cte','lexAndSyn.py',265),
  ('var_cte -> CTE_F','var_cte',1,'p_var_cte','lexAndSyn.py',266),
]
